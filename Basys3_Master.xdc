...
set_property PACKAGE_PIN V17 [get_ports {ABCinput[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ABCinput[0]}]
set_property PACKAGE_PIN V16 [get_ports {ABCinput[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ABCinput[1]}]
set_property PACKAGE_PIN W16 [get_ports {ABCinput[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ABCinput[2]}]
...
set_property PACKAGE_PIN U16 [get_ports {Fstructural }]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Fstructural }]
...
set_property PACKAGE_PIN U2 [get_ports {displayActive[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displayActive[0]}]
set_property PACKAGE_PIN U4 [get_ports {displayActive[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displayActive[1]}]
set_property PACKAGE_PIN V4 [get_ports {displayActive[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displayActive[2]}]
set_property PACKAGE_PIN W4 [get_ports {displayActive[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displayActive[3]}]
