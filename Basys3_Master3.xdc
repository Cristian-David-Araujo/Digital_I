...
#set_property PACKAGE_PIN E19 [get_ports {FdataFlow}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {FdataFlow}]
#set_property PACKAGE_PIN U19 [get_ports {Fbehavioral}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Fbehavioral}]
...
set_property PACKAGE_PIN U2 [get_ports {activeDisplay[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {activeDisplay[0]}]
set_property PACKAGE_PIN U4 [get_ports {activeDisplay[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {activeDisplay[1]}]
set_property PACKAGE_PIN V4 [get_ports {activeDisplay[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {activeDisplay[2]}]
set_property PACKAGE_PIN W4 [get_ports {activeDisplay[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {activeDisplay[3]}]
...
#set_property PACKAGE_PIN R19 [get_ports Vsync]						
	#set_property IOSTANDARD LVCMOS33 [get_ports Vsync]RsRx
